"""autogenerated by genpy from ezls_msgs/LocalizationCommand.msg. Do not edit."""
import sys
...
class LocalizationCommand(genpy.Message):
  _md5sum = "aed81176473cac28ba1bffe3f8399a17"
  _type = "ezls_msgs/LocalizationCommand"
...
"""
  __slots__ = ['timestamp','command','pose']
  _slot_types = ['float64','int32','geometry_msgs/PoseStamped']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LocalizationCommand, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_di3I.pack(_x.timestamp, _x.command, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.timestamp, _x.command, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs,) = _struct_di3I.unpack(str[start:end])
      start = end
      end += 4
